...
namespace OOP_Course_Work
{
    public partial class Form1 : Form
    {
        ...
        private void ShowProducts(IEnumerable<Package> p)
        {
            table.Rows.Clear();
            if (table.Columns.Count == 0)
            {
        ...
        private void searchDeliveryBox_TextChanged(object sender, EventArgs e)
        {
            ShowProducts(current.SearchDeliveryman(searchDeliveryBox.Text));
        }
        private void searchCompanyBox_TextChanged(object sender, EventArgs e)
        {
